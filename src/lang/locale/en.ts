...
export default {
	...
	STATUS_BAR:
		'Review: ${dueNotesCount} note(s), ${dueFlashcardsCount} card(s) due',
	...
	CHECK_WIKI:
		'For more information, check the <a href="${wiki_url}">wiki</a>.',
	...
	MULTILINE_REVERSED_CARDS_SEPARATOR:
		'Separator for multiline reversed flashcards',
	NOTES: 'Notes',
	...
	INITIALLY_EXPAND_SUBDECKS_IN_TREE:
		'Deck trees should be initially displayed as expanded',
	...
	LOGGING: 'Logging',
	DISPLAY_DEBUG_INFO:
		'Display debugging information on the developer console?',
